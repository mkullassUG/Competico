...
@RestController
@Api(value = "DashboardAPI", tags = "The main API managing games")
public class GameAPI
{
	...
	@Autowired
	public GameAPI(LobbyService ls, AccountService as)
	{
		lobbyService = ls;
		accountService = as;
	}
	...
	public boolean lobbyStatusChanged(@PathVariable String gameCode)
	{
		return lobbyService.hasAnthingChanged(gameCode,
