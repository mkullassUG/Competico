...
test('Creating TaskCreatorLogic test with mockjax', function(assert){
    ...
    var tc = TaskCreatorLogic.getInstance(false, $, window, dependencies, function(data) {
        
        assert.equal(data, "success", 'Succesfuly recived message from TaskCreatorLogic Init function.');
        done();
    });
