    ...
    self.taskVariantInit = (taskData) => {
        ...
        for (let i = 0; i < rows; i++) {
            ...
            var BlankContainer = (blank_, wordFillContainer_) => {
                ...
                that.init = (blank) => {
                    console.log("BlankContainer init")
            ...
            var AnswerContainer = (answer_, wordFillContainer_) => {
                ...
                that.init = (answer) => {
                    ...
                    console.log("AnswerContainer init")
            ...
            var WordFillContainer = (containerDiv_) => {
                ...
                that.init = (containerDiv_) => {
                    ...
                    console.log(that.answerElements)
                    console.log(that.blankElements)
                    ...
                    //TODO : #GameDiv ALE nie jeśli nie klikam answer albo blanka 
                    //TODO: BĘDZIE PROBLEM PO ZMIANIE TASKA!!
                    $(document).on('click', (e) => {
