    ...
    self.taskVariantInit = (taskData) => {
      ...
      self.JsPlumbObject = (data) => {
          ...
          that.init = (initData) => {
              ...
              console.log("JsPlumbObject init")
              ...
              //Delete?
              that.instance.bind("beforeDetach", function(connection) {
                  console.log("beforeDetach");
                  console.log(connection);
              });
            
              that.instance.bind("connectionDetached", function(info, originalEvent) {
                  console.log("connectionDetached");
                  console.log(info);
                  console.log(originalEvent);
              });
              that.instance.bind("connectionMoved", function(info, originalEvent) {
                  console.log("connectionMoved");
                  console.log(info);
                  console.log(originalEvent);
              });
            
              that.instance.bind("connectionAborted", function(info, originalEvent) {
                  console.log("connectionMoved");
                  console.log(info);
                  console.log(originalEvent);
              });
            
              that.instance.bind("connectionDrag", function(info) {
                  console.log("connectionDrag");
                  console.log(info);
              });
              that.instance.bind("connectionDragStop", function(info) {
                  console.log("connectionDrag");
                  console.log(info);
              });
          }
