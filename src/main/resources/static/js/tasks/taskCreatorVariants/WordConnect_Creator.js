...
const WordConnect_Creator = (data_ = {}) => {
    ...
    var wordConnectCreatorInit = () => {
        ...
        $("#wordConnectAddConnection").click();
    }
    ...
    self.prepareTaskJsonFile = () => {
        ...
        //slider
        if ($("#customRangeWC").length > 0) {
            self.taskContent.difficulty = $("#customRangeWC").val();
        }
    ...
    self.prepareLoadedTask = () => {
        ...
        /*ustawiam difficulty*/
        $("#customRangeWC").val(self.taskContent.difficulty);
