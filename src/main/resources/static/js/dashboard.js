...
const DashboardLogic = (accountInfo_, debug) => {
    ...
    self.setupLeaderboard = (data) => {
        ...
        var topLeaderboard = $("#topLeaderboard").html(`<h6 class="border-bottom border-gray pb-2 mb-0">Najlepsi gracze:</h6>`);
            ...
            var playerHolder = $(`<div class="media text-muted pt-3 `+(isMe?'bg-light':'')+`">
              ...
              <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                  <div class="d-flex justify-content-between align-items-center w-100">
                        <strong class="d-block">`+ player.username + ` ` + player.nickname + 
                    ...
                    <span class="text-gray-dark">`+player.rating+`</span>
     ...
     self.setupRelativeLeaderboard = (data) => {
      ...
      console.log("self.topPlayers.length " + self.topPlayers.length);
        ...
        topLeaderboard.append("...");
        topLeaderboard.append(`<small class="d-block text-right mt-3">
